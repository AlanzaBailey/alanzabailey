...
# Alanza Bailey
### AWS Cloud Engineer · DevOps · Infrastructure Automation
...
- 🌍 Open to: Remote Cloud Engineer & DevOps Engineer roles
- 📫 Reach me: [linkedin.com/in/alanza-bailey-devops](https://linkedin.com/in/alanza-bailey-devops)
...
|---|---|---|
| [osTicket Setup](https://github.com/AlanzaBailey/osticket-prereqs) | Help desk ticketing system — prerequisites & installation | Windows Server, IIS |
| [Active Directory on Azure](https://github.com/AlanzaBailey/configure-ad) | Configured on-premises AD within Azure VMs | Azure, Active Directory |
| [Network Protocols & NSGs](https://github.com/AlanzaBailey/azure-network-protocols) | Inspected network traffic and configured NSGs | Azure, Wireshark |
| [VPN Setup](https://github.com/AlanzaBailey/Setting-Up-A-VPN) | VPN configuration inside Azure VM | Azure, ProtonVPN |

---

<div align="center">
<sub>Open to remote Cloud Engineer & DevOps roles · Let's build something.</sub>
</div>
